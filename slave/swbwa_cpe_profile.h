...
enum swbwa_cpe_profile_region {
    ...
    SWBWA_CPE_PROFILE_MEM_COLLECT_FIRST,
    SWBWA_CPE_PROFILE_MEM_COLLECT_SPLIT,
    SWBWA_CPE_PROFILE_MEM_COLLECT_LAST,
    SWBWA_CPE_PROFILE_MEM_COLLECT_SORT,
    SWBWA_CPE_PROFILE_CHAIN_BUILD_REPETITIVE,
    SWBWA_CPE_PROFILE_CHAIN_BUILD_SA,
    SWBWA_CPE_PROFILE_CHAIN_BUILD_RID,
    SWBWA_CPE_PROFILE_CHAIN_BUILD_TREE_SEARCH,
    SWBWA_CPE_PROFILE_CHAIN_BUILD_MERGE,
    SWBWA_CPE_PROFILE_CHAIN_BUILD_INSERT,
    SWBWA_CPE_PROFILE_CHAIN_BUILD_FINALIZE
};
...
#define LWPF_KERNELS \
    ...
    K(MEM_COLLECT_LAST) \
    K(MEM_COLLECT_SORT) \
    K(CHAIN_BUILD_REPETITIVE) \
    K(CHAIN_BUILD_SA) \
    K(CHAIN_BUILD_RID) \
    K(CHAIN_BUILD_TREE_SEARCH) \
    K(CHAIN_BUILD_MERGE) \
    K(CHAIN_BUILD_INSERT) \
    K(CHAIN_BUILD_FINALIZE)
