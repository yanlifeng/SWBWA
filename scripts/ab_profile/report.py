...
Usage: report.py <out_dir> [cross|single]
Reads ab_stage2.tsv / kernel_diff.tsv / kernel_new_breakdown.tsv from out_dir.
"""
import os
import sys
...
print("(WORKER_ALIGNMENT + SAM_COPY; the nested regions are NOT summed).\n")
kernels = []
for r in diff:
