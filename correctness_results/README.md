...
2026 年 9 月新增归档：`bigdata_run_20260910/`（大数据回归）、
`profile_ab_20260913/`（CPE kernel A/B）、`deploy_ab_20260914/`（部署与启动成本）、
`deploy_tailoff_20260916/`（关闭尾块细分）。各目录说明和日志保存当时的版本/配置，
不自动视为后续代码的验证结果。
